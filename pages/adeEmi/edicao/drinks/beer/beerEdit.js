                ...
                <div class="row clearfix" style="margin-top: 120px;">
                    ...
                    <div class="form">
                        ...
                        <div class="column">
                            ...
                            <select name="Color" id="Color" class="formItemBigger" form="carform">
                                <option  ${doc.data().Color == "Clara" ? "selected = selected" : ""} class="opt" value="Clara">Clara (>20 de EBC)</option>
                                <option  ${doc.data().Color == "Escura" ? "selected = selected" : ""} class="opt" value="Escura">Escura (>= 20 de EBC)</option>
                            </select>
                    ...
                    <div class="form">
                        <div class="column">
                            ...
                            <select class="formItemBigger" id="Tipo" form="carform">
                                <option  ${doc.data().Tipo == "Pilsen" ? "selected = selected" : ""}class="opt" value="Pilsen">Pilsen</option>
                                <option  ${doc.data().Tipo == "Weiss" ? "selected = selected" : ""} class="opt" value="Weiss">Weiss</option>
                                <option  ${doc.data().Tipo == "Witbier" ? "selected = selected" : ""} class="opt" value="Witbier">Witbier</option>
                                <option  ${doc.data().Tipo == "IPA" ? "selected = selected" : ""} class="opt" value="IPA">India Pale Ale (IPA)</option>
                                <option  ${doc.data().Tipo == "Belgian Pale Ale" ? "selected = selected" : ""} class="opt" value="Belgian Pale Ale">Belgian Pale Ale</option>
                                <option  ${doc.data().Tipo == "Porter" ? "selected = selected" : ""} class="opt" value="Porter">Porter</option>
                                <option  ${doc.data().Tipo == "Stout" ? "selected = selected" : ""} class="opt" value="Stout">Stout</option>
                                <option  ${doc.data().Tipo == "Bock" ? "selected = selected" : ""} class="opt" value="Bock">Bock</option>
                                <option  ${doc.data().Tipo == "English IPA" ? "selected = selected" : ""} class="opt" value="English IPA">English IPA</option>
                                <option  ${doc.data().Tipo == "American IPA" ? "selected = selected" : ""} class="opt" value="American IPA">American IPA</option>
                                <option  ${doc.data().Tipo == "Saison" ? "selected = selected" : ""} class="opt" value="Saison">Saison</option>
                                <option  ${doc.data().Tipo == "Belgian Tripel" ? "selected = selected" : ""} class="opt" value="Belgian Tripel">Belgian Tripel</option>
                                <option  ${doc.data().Tipo == "Belgian White" ? "selected = selected" : ""} class="opt" value="Belgian White">Belgian White</option>
                                <option  ${doc.data().Tipo == "Golden Lager" ? "selected = selected" : ""} class="opt" value="Golden Lager">Golden Lager</option>
                                <option  ${doc.data().Tipo == "Blonde" ? "selected = selected" : ""} class="opt" value="Blonde">Blonde</option>
                            </select>
                        </div>
                        <div class="column">
                            <label for="inputEmail4" class="lbl">Copo ideal:</label>
                            <input type="text" class="formItem" value="${doc.data().Cup}" id="Cup" placeholder="Ex: Pint" aria-label="Last name">
                        </div>
                    ...
                    <div class="form">
                        <div class="column">
                            ...
                            <input type="number" value="${doc.data().Price}" class="formItem" id="Price"
                        ...
                        <div class="column">
                            ...
                            <input type="text" class="formItem" id="Pais" value="${doc.data().Pais}" placeholder="Ex: bélgica"
...
function UpdateDrink(Arg) {
    ...
    if (Nome == "" || Tipo == "" || Pais == "" || Price == "" || Color == "" || Cup == "") {
        ...
        let Att = db.collection("Loja")
            .doc("Bebidas")
            .collection("Cervejas").doc(drinkId.toString().trim())
