            ...
            <div class="row clearfix" style="margin-top: 120px;">
                ...
                <div class="form">
                    ...
                    <div class="column">
                        ...
                        <select class="formItemBigger" id="Uva" form="carform">
                            <option  ${doc.data().Uva == "Alicante Bouschet" ? "selected = selected" : ""} class="opt" value="Alicante Bouschet">Alicante Bouschet</option>
                            <option  ${doc.data().Uva == "Ancellota" ? "selected = selected" : ""} class="opt" value="Ancellota">Ancellota</option>
                            <option  ${doc.data().Uva == "Barbera" ? "selected = selected" : ""} class="opt" value="Barbera">Barbera</option>
                            <option  ${doc.data().Uva == "Cabernet Franc" ? "selected = selected" : ""} class="opt" value="Cabernet Franc">Cabernet Franc</option>
                            <option  ${doc.data().Uva == "Cabernet Sauvignon" ? "selected = selected" : ""} class="opt" value="Cabernet Sauvignon">Cabernet Sauvignon</option>
                            <option  ${doc.data().Uva == "Carménère" ? "selected = selected" : ""} class="opt" value="Carménère">Carménère</option>
                            <option  ${doc.data().Uva == "Gamay" ? "selected = selected" : ""} class="opt" value="Gamay">Gamay</option>
                            <option  ${doc.data().Uva == "Malbec" ? "selected = selected" : ""} class="opt" value="Malbec">Malbec</option>
                            <option  ${doc.data().Uva == "Nebbiolo" ? "selected = selected" : ""} class="opt" value="Nebbiolo">Nebbiolo</option>
                            <option  ${doc.data().Uva == "Petit Verdot" ? "selected = selected" : ""} class="opt" value="Petit Verdot">Petit Verdot</option>
                            <option  ${doc.data().Uva == "Pinotage" ? "selected = selected" : ""} class="opt" value="Pinotage">Pinotage</option>
                            <option  ${doc.data().Uva == "Pinot Noir" ? "selected = selected" : ""} class="opt" value="Pinot Noir">Pinot Noir</option>
                            <option  ${doc.data().Uva == "Sangiovese" ? "selected = selected" : ""} class="opt" value="Sangiovese">Sangiovese</option>
                            <option  ${doc.data().Uva == "Syrah" ? "selected = selected" : ""} class="opt" value="Syrah">Syrah</option>
                            <option  ${doc.data().Uva == "Tannat" ? "selected = selected" : ""} class="opt" value="Tannat">Tannat</option>
                            <option  ${doc.data().Uva == "Tempranillo" ? "selected = selected" : ""} class="opt" value="Tempranillo">Tempranillo</option>
                            <option  ${doc.data().Uva == "Touriga Nacional" ? "selected = selected" : ""} class="opt" value="Touriga Nacional">Touriga Nacional</option>
                        </select>
                    </div>
                ...
                <div class="form">
                    <div class="column">
                        ...
                        <textarea class="formItem" id="Harmonizacao" rows="3">${doc.data().Harmonizacao}</textarea>
                    </div>
                </div>
...
function UpdateDrink() {
    ...
    if (Nome == "" || Tipo == "" || Pais == "" || Price == "") {
        ...
        let Att = db.collection("Loja")
            .doc("Bebidas")
            .collection("Vinhos").doc(drinkId.toString().trim())
